  ...
  return (
    <html lang="de">
      <body className="flex-col bg-sandy">
        ...
        <div className="w-screen flex justify-center fixed bottom-0 bg-sandy mb-10">
          ...
          <button className="w-1/3 xl:w-1/4 h-14 flex justify-center items-center mb-3 ml-8 mr-3 rounded-lg shadow-sm bg-sandy shadow-slate-700">
            Sign Up
          </button>
        </div>
      </body>
