      ...
      <div className="w-full max-w-2xl space-y-4">
        <div className="relative flex items-center max-w-xs sm:max-w-sm mx-auto w-full">
          <input
            ...
            autoFocus
            className="block w-full rounded-xl border bg-background px-5 py-4 pr-14 tracking-wider text-foreground shadow transition placeholder:text-muted-foreground/60 focus:outline-none focus:border-muted-foreground/40 focus:ring-0"
            onKeyDown={(event) => {
              if (event.key === "Enter") {
                handleSubmit();
              }
